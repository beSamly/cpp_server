...
#ifndef GOOGLE_PROTOBUF_INCLUDED_LoginRequest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_LoginRequest_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_LoginRequest_2eproto;
namespace Protocol {
class LoginRequest;
...
inline const std::string& LoginRequest::email() const {
  // @@protoc_insertion_point(field_get:Protocol.LoginRequest.email)
...
void LoginRequest::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.email_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.LoginRequest.email)
}
inline std::string* LoginRequest::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:Protocol.LoginRequest.email)
  return _s;
}
...
inline std::string* LoginRequest::release_email() {
  // @@protoc_insertion_point(field_release:Protocol.LoginRequest.email)
...
inline void LoginRequest::set_allocated_email(std::string* email) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.LoginRequest.email)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_LoginRequest_2eproto
