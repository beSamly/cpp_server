...
static ::_pb::Metadata file_level_metadata_SearchRequest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_SearchRequest_2eproto = nullptr;
...
const uint32_t TableStruct_SearchRequest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::SearchRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::SearchRequest, _impl_.query_),
  PROTOBUF_FIELD_OFFSET(::Protocol::SearchRequest, _impl_.page_number_),
  PROTOBUF_FIELD_OFFSET(::Protocol::SearchRequest, _impl_.result_per_page_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::SearchRequest)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Protocol::_SearchRequest_default_instance_._instance,
};

const char descriptor_table_protodef_SearchRequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023SearchRequest.proto\022\010Protocol\"L\n\rSearc"
...
const ::_pbi::DescriptorTable descriptor_table_SearchRequest_2eproto = {
    false, false, 117, descriptor_table_protodef_SearchRequest_2eproto,
    "SearchRequest.proto",
...
SearchRequest::SearchRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Protocol.SearchRequest)
}
SearchRequest::SearchRequest(const SearchRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.SearchRequest)
}
...
SearchRequest::~SearchRequest() {
  // @@protoc_insertion_point(destructor:Protocol.SearchRequest)
...
// @@protoc_insertion_point(message_clear_start:Protocol.SearchRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.SearchRequest.query"));
        } else
          goto handle_unusual;
        continue;
      // int32 page_number = 2;
...
uint8_t* SearchRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.SearchRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.SearchRequest)
  return target;
}

size_t SearchRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.SearchRequest)
  size_t total_size = 0;
...
void SearchRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.SearchRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.SearchRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::Protocol::SearchRequest*
Arena::CreateMaybeMessage< ::Protocol::SearchRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::SearchRequest >(arena);
}
