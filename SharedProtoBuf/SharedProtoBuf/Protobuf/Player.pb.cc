...
const uint32_t TableStruct_Player_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, _impl_.username_),
  PROTOBUF_FIELD_OFFSET(::Protocol::Player, _impl_.equipitems_),
};
...
const char descriptor_table_protodef_Player_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Player.proto\022\010Protocol\032\017EquipItem.prot"
  "o\"V\n\006Player\022\021\n\tAccountId\030\001 \001(\004\022\020\n\010Userna"
  "me\030\002 \001(\t\022\'\n\nEquipItems\030\003 \003(\0132\023.Protocol."
  "EquipItemb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Player_2eproto = {
    false, false, 137, descriptor_table_protodef_Player_2eproto,
    "Player.proto",
    &descriptor_table_Player_2eproto_once, descriptor_table_Player_2eproto_deps, 1, 1,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.Player.Username"));
        } else
          goto handle_unusual;
        continue;
