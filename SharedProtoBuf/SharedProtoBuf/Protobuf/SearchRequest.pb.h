...
PROTOBUF_NAMESPACE_OPEN
template<> ::Protocol::SearchRequest* Arena::CreateMaybeMessage<::Protocol::SearchRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Protocol {
...
class SearchRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.SearchRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.SearchRequest)
 private:
  class _Internal;
...
inline const std::string& SearchRequest::query() const {
  // @@protoc_insertion_point(field_get:Protocol.SearchRequest.query)
...
void SearchRequest::set_query(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.query_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.SearchRequest.query)
}
inline std::string* SearchRequest::mutable_query() {
  std::string* _s = _internal_mutable_query();
  // @@protoc_insertion_point(field_mutable:Protocol.SearchRequest.query)
  return _s;
}
...
inline std::string* SearchRequest::release_query() {
  // @@protoc_insertion_point(field_release:Protocol.SearchRequest.query)
...
inline void SearchRequest::set_allocated_query(std::string* query) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Protocol.SearchRequest.query)
}
...
inline int32_t SearchRequest::page_number() const {
  // @@protoc_insertion_point(field_get:Protocol.SearchRequest.page_number)
...
inline void SearchRequest::set_page_number(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Protocol.SearchRequest.page_number)
}
...
inline int32_t SearchRequest::result_per_page() const {
  // @@protoc_insertion_point(field_get:Protocol.SearchRequest.result_per_page)
...
inline void SearchRequest::set_result_per_page(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:Protocol.SearchRequest.result_per_page)
}
